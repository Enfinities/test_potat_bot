from potato_functions import read_potatos_by_discord_id
...
def test_read_potatos_by_discord_id_multiple_matches():
    potatoes = [
    ...
    result_potatoes = read_potatos_by_discord_id(potatoes, 123456789)
...
def test_read_potatos_by_discord_id_single_match():
    potatoes = [
    ...
    # Call the read_potatos_by_discord_id function
    result_potatoes = read_potatos_by_discord_id(potatoes, 987654321)
...
def test_read_potatos_by_discord_id_no_match():
    potatoes = [
        {'owner_name': 'John Doe', 'owner_discord_id': 123456789, 'name': 'Achievement 1', 'potato_type': 'Personal', 'price': 10.5, 'accomplishment': 'Completed task', 'date': '2024-01-08'},
